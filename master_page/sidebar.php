...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">nazish</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item active open">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="settings.php" target="_blank" class="menu-link">
            <div data-i18n="eCommerce">Settings</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="#" target="_blank" class="menu-link">
            <div data-i18n="Logistics">Profile Status</div>
            <div class="badge bg-success rounded-pill ms-auto">100%</div>
            </a>
        </li>
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="Layouts">New Purchase</div>
      </a>
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="Front Pages">Grocery</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">Financial Expenses</span>
    </li>
    <!-- Apps -->
    <li class="menu-item">
      <a href="#" target="_blank" class="menu-link">
        <i class="menu-icon tf-icons bx bx-envelope"></i>
        <div data-i18n="Email">Track Expense</div><div class="badge bg-label-primary fs-tiny rounded-pill ms-auto">Pro</div>
      </a>
    </li>
    ...
    <li class="menu-item">
      <a href="cards-basic.html" class="menu-link">
        ...
        <div data-i18n="Basic">Donate</div>
      </a>
    </li>


    <li class="menu-item">
      <a href="https://www.buymeacoffee.com/nazish" class="menu-link">
        <i class="menu-icon tf-icons bx bx-coffee-togo"></i>
        <div data-i18n="Basic">Buy Me a Coffee</div>
      </a>
    </li>
